...
int main(){
    ...
    */
    ...
    //Capacity is the amount of memory allocated to the std::string 
    /*
    std::string str1 {"Hello World"};
    std::string str2;
    ...
    */
    ...
    //Reserve : Update the capacity i.e increase the memory space allocated for the std::string var
    /*
    std::string str1 {"Hello World"};
    ...
    */
    ...
    //shrink_to_fit give exaclty the space it needed 
