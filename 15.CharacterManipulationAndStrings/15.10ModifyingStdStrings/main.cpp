...
int main(){
    ...
    */
	...
	//Inserts count characters (means how many times) in the string starting at index index
    /*/
    std::string str2 {"122"};
    std::cout << "str2 : " << str2 << std::endl;
    
    // this means starting from the index 1 print 3 four times
    ...
    */
	...
	//Insert (2)
    // insert the string at the at any index
    ...
    */
	...
	//Insert (3)
    // Insert only selected number of charachters from the string at any index to another string
