...
int main(){
    ...
    std::cout.unsetf(std::ios::scientific | std::ios::fixed); // Hack remove the output foramtting of the floating point unsetf mean remove and | operator means remove the both flags 
    std::cout << "a : " << a << std::endl;
    std::cout << "b : " << b << std::endl;
    std::cout << "c : " << c << std::endl;
